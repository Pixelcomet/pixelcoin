...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/pixelcoin-project/pixelcoin>";
    const std::string URL_WEBSITE = "<https://pixelcoin.org>";
