...
#if defined(NDEBUG)
# error "Pixelcoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Pixelcoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s PXC additional fees, %d delta bytes\n",
