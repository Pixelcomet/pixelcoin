...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s pixelcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  pixelcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded pixelcoin transaction") + "\n" +
              "  pixelcoin-tx [options] -create [commands]   " + _("Create hex-encoded pixelcoin transaction") + "\n" +
              "\n";
